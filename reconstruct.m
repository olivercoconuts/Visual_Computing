function [result] = reconstruct(scandir);

load cam.mat;
thresh = 0.02;

[L_h,L_h_good] = decode(strcat(scandir,'frame_C1_'),0,19,thresh);
[L_v,L_v_good] = decode(strcat(scandir,'frame_C1_'),20,39,thresh);
[R_h,R_h_good] = decode(strcat(scandir,'frame_C0_'),0,19,thresh);
[R_v,R_v_good] = decode(strcat(scandir,'frame_C0_'),20,39,thresh);
